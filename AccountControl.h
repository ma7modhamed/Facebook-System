...
namespace FacebookSystem {
	...
	/// <summary>
	/// Summary for AccountControl
	/// </summary>
	public ref class AccountControl : public System::Windows::Forms::UserControl
	{
	public:
		String^ e_mail;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(AccountControl::typeid));
			...
			this->pictureBox1->Location = System::Drawing::Point(21, 10);
			...
			this->AccountName->Location = System::Drawing::Point(95, 10);
			...
			this->AccountName->Click += gcnew System::EventHandler(this, &AccountControl::label1_Click);
			// 
			// RequestPanel
			// 
			...
			this->RequestPanel->Location = System::Drawing::Point(99, 39);
			...
			this->DeleteRequestButton->Click += gcnew System::EventHandler(this, &AccountControl::DeleteRequestButton_Click);
			// 
			// ConfirmButton
			// 
			...
			this->ConfirmButton->Click += gcnew System::EventHandler(this, &AccountControl::ConfirmButton_Click);
			// 
			// AddFriendPanel
			// 
			this->AddFriendPanel->BackColor = System::Drawing::Color::Transparent;
			this->AddFriendPanel->Controls->Add(this->AddFriendButton);
			this->AddFriendPanel->Location = System::Drawing::Point(522, 54);
			...
			this->AddFriendPanel->TabIndex = 4;
			// 
			// AddFriendButton
			// 
			...
			this->AddFriendButton->Click += gcnew System::EventHandler(this, &AccountControl::AddFriendButton_Click);
			// 
			// RequestSentPanel
			// 
			...
			this->RequestSentPanel->Location = System::Drawing::Point(522, -1);
			...
			this->RequestSentPanel->TabIndex = 3;
			// 
			// label2
			// 
			...
			this->UndoButton->Click += gcnew System::EventHandler(this, &AccountControl::UndoButton_Click);
			// 
			// FriendsPanel
			// 
			...
			this->FriendsPanel->Location = System::Drawing::Point(317, 10);
			...
			this->FriendsButton->Click += gcnew System::EventHandler(this, &AccountControl::FriendsButton_Click);
			// 
			// panel1
			// 
			...
			this->bunifuThinButton21->Click += gcnew System::EventHandler(this, &AccountControl::bunifuThinButton21_Click);
			// 
			// AccountControl
			// 
			...
			this->Name = L"AccountControl";
			this->Size = System::Drawing::Size(331, 99);
...
#pragma endregion
	private: System::Void label1_Click(System::Object^  sender, System::EventArgs^  e) {
		UserProfile^up = gcnew UserProfile(e_mail);
		up->Show();
	}
